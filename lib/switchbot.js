  ...
  _getDeviceObject(peripheral, id, model) {
    ...
    if (this._filterAdvertising(ad, id, model)) {
      ...
      switch (ad.serviceData.model) {
        case 'H':
          device = new SwitchbotDeviceWoHand(peripheral, this.noble, this.onlog);
          break;
        case 'e':
          device = new SwitchbotDeviceWoHumi(peripheral, this.noble, this.onlog);
          break;
        case 'T':
          device = new SwitchbotDeviceWoSensorTH(peripheral, this.noble, this.onlog);
          break;
        case 's':
          device = new SwitchbotDeviceWoPresence(peripheral, this.noble, this.onlog);
          break;
        case 'd':
          device = new SwitchbotDeviceWoContact(peripheral, this.noble, this.onlog);
          break;
        case 'c':
          device = new SwitchbotDeviceWoCurtain(peripheral, this.noble, this.onlog);
          break;
        default: // 'resetting', 'unknown'
          device = new SwitchbotDevice(peripheral, this.noble, this.onlog);
      }
      return device;
    } else {
      return null;
